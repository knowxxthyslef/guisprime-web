...
@Component({
  ...
  templateUrl: './patrones-vigentes-sin-trabajadores.component.html',
  styleUrls: ['./patrones-vigentes-sin-trabajadores.component.scss']
})
export class PatronesVigentesSinTrabajadoresComponent extends GeneralComponent implements OnInit {
